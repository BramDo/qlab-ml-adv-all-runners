...
Gepubliceerd op 20 juli 2026 als een pagina-hub met zeven onderliggende
artikelen:

- Seriehub: https://edukaizen.nl/quantum-oracle-sketching-qml-genexpressie/
- WordPress-hubpagina: `498`
- WordPress-artikelpagina's: `499` tot en met `505`
- Hoofdmenu-item `QOS QML`: `506`
- Onderliggende menu-items: `507` tot en met `513`
...
6. [Het resultaat: hardware 16, klassiek 17](https://edukaizen.nl/quantum-oracle-sketching-qml-genexpressie/resultaat-hardware-versus-klassiek/) — pagina `505`
...
Na publicatie zijn alle acht publieke URL's met HTTP-status `200` gecontroleerd.
