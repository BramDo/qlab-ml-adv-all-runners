#!/usr/bin/env python3
"""Bounded classifier proof on top of the official IMDb Qiskit bridge."""
...
from qiskit_official_qos_imdb_bridge import load_curve_point  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Bounded classifier proof on top of the official IMDb Qiskit bridge"
    )
