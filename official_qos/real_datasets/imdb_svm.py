...
def get_ridge_results_full():
    ...
    LOGGER.log(
        "dataset_load_done",
        num_documents=len(X_all_raw),
        num_labels=int(len(y_all)),
    )
...
def run_analysis(load_file=None):
    ...
    if load_file is not None:
        ...
        LOGGER.log(
            "json_saved",
            path="imdb_size_vs_accuracy.json",
            num_points=len(results["min_dfs"]),
        )
    ...
    LOGGER.log("pdf_saved", path="imdb_size_vs_accuracy.pdf")
